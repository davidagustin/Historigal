...
export default class Home extends Component {
  ...
  handlePageClick(e) {
    this.getData(e.selected + 1); // Argument must offset by 1 due to pagination;
    window.scrollTo(0, 0);
  };
    ...
    return (
      <div>
        <div className='searchInSearch'>
          <img className='logoInSearch'
               src='historigal.png'
               onClick={() => {
                 this.props.resetInputBar();
        ...
        <div className={'searchItems'}>
          {this.state.emptySearch ?
            ...
            <div>
              <SearchItems totalItemsInSearch={this.state.totalItemsInSearch}
                           results={this.state.searchResult}/>
              <img className={'logoInSearchBottom'}
                   src='historigal.png'/>
              <div>
                <ReactPaginate
